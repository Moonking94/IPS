            ...
            protected Map<String, String> getParams() {
                ...
                if(listRI.size() > 0 && !listRI.isEmpty()) {
                    for (int i = 0; i < listRI.size(); i++) {
                        ...
                        if(listRI.get(i).getBssid().equals("18:a6:f7:0d:51:04") && status) { // PiAP 18:a6:f7:0d:51:04
                            ...
                            params.put("p1[1]", listRI.get(i).getBssid());
                            params.put("p1[2]", listRI.get(i).getSignalLvl() + "");
                        } else if(listRI.get(i).getBssid().equals("c8:d3:a3:dd:8e:10")) { // nana_ian c8:d3:a3:dd:8e:10
                            params.put("p2[0]", listRI.get(i).getSsid());
                            params.put("p2[1]", listRI.get(i).getBssid());
                            params.put("p2[2]", listRI.get(i).getSignalLvl() + "");
                        } else if(listRI.get(i).getBssid().equals("d8:5d:4c:db:bb:f8")) { // TP-LINK_DBBBF8 b8:27:eb:1b:c5:23
                            params.put("p3[0]", listRI.get(i).getSsid());
                            params.put("p3[1]", listRI.get(i).getBssid());
                            params.put("p3[2]", listRI.get(i).getSignalLvl() + "");
                        } else if (listRI.get(i).getBssid().equals("b8:27:eb:81:20:99") && status) { // JeffPi b8:27:eb:81:20:99
                            params.put("p3[0]", listRI.get(i).getSsid());
                            params.put("p3[1]", listRI.get(i).getBssid());
                            params.put("p3[2]", listRI.get(i).getSignalLvl() + "");
                            ...
                            params.put("p3[1]", listRI.get(i).getBssid());
                            params.put("p3[2]", listRI.get(i).getSignalLvl() + "");
                        } else if (listRI.get(i).getBssid().equals("6e:5f:1c:d5:c8:b1") && status) { // LenovoS650 BSSID
                            params.put("p1[0]", listRI.get(i).getSsid());
                            params.put("p1[1]", listRI.get(i).getBssid());
                            params.put("p1[2]", listRI.get(i).getSignalLvl() + "");
